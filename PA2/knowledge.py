...
monster_sentences = ['Vampire(Celene)',
                     ...
                     'Vampire(x) & Victim(y) & Suspected(x) & Bitten(y) ==> Killed(x,y)',
                     'Werewolf(x) & Victim(y) & Suspected(x) & Eaten(y) ==> Killed(x,y)',
                     'Witch(x) & Victim(y) & Suspected(x) & Poisoned(y) ==> Killed(x,y)',
                     ...
                     'Victim(x) & Intact(x) & Boils(x) & Complexion(x, Pale) ==> Poisoned(x)',
                     'Victim(x) & Punctured(x) & Complexion(x, Pale) ==> Drained(x)',
                     'Victim(x) & Cold(x) & Complexion(x, Pale) ==> Drained(x)',
